...
{\small
\begin{longtable}{L{0.21\textwidth}L{0.20\textwidth}L{0.26\textwidth}L{0.23\textwidth}}
\toprule
...
{\small
\begin{longtable}{L{0.20\textwidth}L{0.17\textwidth}L{0.18\textwidth}L{0.35\textwidth}}
\toprule
...
Binary paired pre/post change & The current app does not model paired binary change directly. & McNemar-based or paired binary methods.\\
