...
The executable is built with PyInstaller. Because `ISP v2.1` depends on `intervention_sample_planner/explanations.json`, the build command must include that file.
